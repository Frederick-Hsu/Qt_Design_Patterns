...
#define QOBJECTTREE_H
    ...
    public:
        ...
        QObjectTreeItem(QObject* obj_in, QObjectTreeItem* parent = nullptr);
        ~QObjectTreeItem();
    public:
    ...
    class QOBJECTBROWSERSHARED_EXPORT QObjectTreeModel : public QAbstractItemModel
    /* A concrete tree model implemented from QAbstractItemModel, that allows a
     * QTreeView to inspect the QObjects in memory, and all of their
     * QMetaObject/Property/Type/Method info.
     */
    {
        Q_OBJECT
    public:
        QObjectTreeModel(QObject* parent = nullptr);
        virtual ~QObjectTreeModel();
    ...
    class QOBJECTBROWSERSHARED_EXPORT QObjectTree : public QTreeView
    {
        Q_OBJECT
    public:
        QObjectTree();
